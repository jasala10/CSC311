...
for iter = 1:n_iterations
    ...
    y_FA = SKIP_mapnet();              % for FA
    y_mFA = SKIP_mapnet();
    y_BP = SKIP_mapnet();

    % ERROR CORRECTION (we want identical initialization):
    test_m = [0; 49; 49; 1568]; % for convolution
    ...
    for epoch = 1:n_epochs
        ...
        for batch = 1:n_batches 
            ...
            % forward pass
            y_FA = SKIP_forward(y_FA, minibatch_images');
            y_mFA = SKIP_forward(y_mFA, minibatch_images');
            y_BP = SKIP_forward(y_BP, minibatch_images');
           ...
           % calculate error and loss
            ...
            % backward pass    
            y_FA = SKIP_FA(y_FA, e_FA); 
            y_mFA = SKIP_mFA(y_mFA, e_mFA);
            y_BP = SKIP_backprop(y_BP, e_BP); 
