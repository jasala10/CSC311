...
test_m = [0; 49; 49; 1568];
% scaling factor to initialize the weights in the network, 
% a good choice can prevent vanishing or exploding gradients
...
[net.W, net.W_, net.W__, net.WB, net.b, net.b_, net.b__, net.v, net.v_, net.v__, ...
...
for l = 2:net.n_layers % l = 2, 3, 4
    ...
    if l == 4 % (10 x 1568)
        ...
        % NEW: for FA
        net.WB{l} = m*randn(n_neurons(l), n_neurons(l - 1)+n_neurons(l-2));
    else      % (784 x 784)
        ...
        % NEW: for FA
        net.WB{l} = m*randn(n_neurons(l), n_neurons(l - 1)); 
